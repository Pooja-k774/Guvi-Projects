...
def datafr():
    df= pd.read_csv("C:/Users/ACER/Desktop/VM/PhonePe/Airbnb.csv")
    return df

df= datafr()

with st.sidebar:
    select = option_menu("Main Menu",["Home","Data Exporation","About"])


if select == "Home":
    image1= Image.open("C:/Users/ACER/Desktop/AirbnbImage.jpeg")
    st.image(image1)
    ...
    st.write("")
    st.write('''***Airbnb was launched in 2007 when two Hosts welcomed three guests to their
...
if select == "Data Exporation":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/ACER/Desktop/VM/PhonePe/Airbnb.csv")
            return df_a
